import socket
import threading
from ContentConnectionHandler import ContentConnection
...
class ContentNetworkInterface:
    def __init__(self):
        self.listeners = []
        self.connectionHandler = ContentConnection()
        self.running = True
    ...
    # Start client
    def start_content(self, ip, port, duration=20, retries=30):
